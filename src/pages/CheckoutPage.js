  ...
  return (
    ...
    <div>
      ...
      {addresses.map((address) => (
        <li key={address.email} className="flex justify-between gap-x-6 px-7 py-5  border-solid border-2 border-gray-200">
          ...
          <div className="mx-auto mt-9 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
     
     <div className="border-t border-gray-200 px-4 py-5 sm:px-3 mt-12" >
