                    ...
                    <div className="mx-auto max-w-2xl px-4 py-0   sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3   xl:gap-x-6 ">
                        {products.map((products) => (
                          ...
                          <div key={products.id} className="group relative border-solid border-2 p-4 border-gray-200">
                            ...
                            <div className="mt-4 flex justify-between ">
                              <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                  ...
                                  <span className="align-bottom">{products.rating}</span>
                                </p>
                              </div>
                              <div>
